<#
.SYNOPSIS
    Script para eliminar el bloatware de Lenovo. Pensado y orientado para lanzarse en backkground desatentido con Intune como Script Platform
...
.DESCRIPTION
    ...
    Este script ha sido creado por HPC-Germany y editado/mejorado por Alejandro Suárez. 
...
if ($mcafeeinstalled -eq "true") {
    ...
    ## Origen descarga
    $URL = 'https://github.com/Inkoova/Intune-Lenovo-CleanBloatware/blob/main/mcafeeclean.zip'
